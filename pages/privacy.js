  ...
  return (
    <div className="wrap">
      <div className="card">
        ...
        <p>Agency contact info (name, email, phone), creator profile info (nickname, TikTok handle, diamond counts, league, timezone, optional profile picture and gender), and battle/post activity within your agency.</p>
