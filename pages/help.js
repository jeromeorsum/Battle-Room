...
const CATEGORIES = [
  {
    ...
    faqs: [
      ...
      { q: 'How do I set up my agency?', a: 'Go to the Sign Up page, choose a plan, pick an admin code (your master password), enter your date of birth and contact email, and agree to the Terms. You\u2019ll get an agency code to share with your creators and a 14-day free trial to try everything.' },
      { q: 'How do I add creators to my roster?', a: 'Two ways. As an admin you can add them yourself from the Roster section of the admin panel (enter their nickname, handle, diamonds, league, and timezone). Or share your agency code and let creators sign themselves up — they enter the code, create a profile with a nickname and PIN, and confirm their own age.' },
      { q: 'How do I join my agency (as a creator)?', a: 'Ask your agency admin for your agency code, enter it on the \u201cI have an agency code\u201d page, then create your profile or sign in with your nickname and PIN.' },
